...
namespace LaZonaSV.AccesoADatos.Tests
{
    ...
    {
        private static Usuario usuarioInicial = new Usuario { Id = 2, IdRol = 1, Login = "Fernanlml", Password = "12345" };
        ...
        public async Task T2ModificarAsyncTest()
        {
            ...
            usuario.IdRol = usuarioInicial.IdRol;
            usuario.Nombre = "Fernanlml";
            usuario.Apellido = "Garcia";
            usuario.Login = "Fernanlml";
            usuario.Estatus = (byte)Estatus_Usuario.ACTIVO;
